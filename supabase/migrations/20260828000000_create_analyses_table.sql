-- REVO V2 Production Database Migration
-- Table: public.analyses
-- Description: Stores website observation evidence, structured AI analysis reports, processing timings, and metadata.
...
-- Policies
-- 1. Read Policy: Allow anyone with the analysis ID to read the public analysis record
CREATE POLICY "Allow public read of analyses"
    ON public.analyses
    FOR SELECT
    USING (true);

-- 2. Service Role & Authenticated Policy: Full access for server-side management
